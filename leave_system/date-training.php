<html>
 <head>
  <title></title>
  <link rel="stylesheet" type="text/css" href="date_training.css"/>
 ...
 <?php
  ...
  $query = mysqli_query($con,"SELECT * FROM apply_leave WHERE date BETWEEN '$from_date' AND '$to_date' and role='training' and status='$s' and username='$a'");
