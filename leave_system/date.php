<html>
 ...
 <?php
  ...
  $query = mysqli_query($con,"SELECT * FROM apply_leave WHERE date BETWEEN '$from_date' AND '$to_date' and role='managing team' and status='$s' and username='$a'");
  if(mysqli_num_rows($query)>0)
  {
  ?>
  <table class="table table-primary table-striped table-managing">  
   <tr>
    <th>Name</th>
    <th>Username</th>
    <th>Id no</th>
